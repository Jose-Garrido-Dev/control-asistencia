    <x-admin-layout>
        ...
        <div class="flex justify-end mb-4">
            <a href="{{ route('attendances.export') }}" download class="flex items-center text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                Descargar Reporte  <div class="mr-2"></div> <i class="fa-solid fa-table"></i>
            </a>
